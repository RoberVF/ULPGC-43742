...
<div class="max-w-7xl mx-auto p-6 bg-gray-50 min-h-screen">
    <div class="flex flex-col md:flex-row justify-between items-center mb-8 bg-white p-4 rounded-lg shadow-sm">
        ...
        <div class="flex items-center space-x-3 mt-4 md:mt-0">
            <input type="text" id="sensor_id_graf" class="p-2 border rounded shadow-sm focus:ring-2 focus:ring-blue-500 outline-none" placeholder="DNI Vendedor" value="87654321Y">
            <button id="btn-actualizar" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition-all shadow-md">
                Actualizar Datos
            </button>
        </div>
    </div>
