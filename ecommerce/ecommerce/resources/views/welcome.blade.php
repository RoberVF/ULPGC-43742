...
<head>
    ...
    <title>EconMarket - Conectando Productores, Vendedores y Clientes</title>
...
<body class="bg-zinc-950 text-white antialiased">
    ...
    <section class="relative min-h-screen flex items-center justify-center pt-16 hero-gradient">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center max-w-4xl mx-auto">
                <!-- Badge -->
                <div class="inline-flex items-center gap-2 bg-zinc-900 border border-zinc-800 rounded-full px-4 py-2 mb-8">
                ...
                <p class="text-lg sm:text-xl text-zinc-400 max-w-2xl mx-auto mb-10">
                    EconMarket une a productores, vendedores y clientes en un unico ecosistema digital. 
                    Optimiza tu negocio y alcanza nuevos mercados.
                </p>
                
                <!-- CTA Buttons -->
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
                    <a href="#" class="w-full sm:w-auto bg-green-500 hover:bg-green-600 text-zinc-950 font-semibold px-8 py-4 rounded-xl transition-all btn-glow text-center">
                        Comenzar Ahora
                    </a>
                    <a href="#como-funciona" class="w-full sm:w-auto bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 text-white font-semibold px-8 py-4 rounded-xl transition-all text-center">
                        Ver Como Funciona
                    </a>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-zinc-400 max-w-2xl mx-auto">
                    Cada participante en EconMarket tiene un papel fundamental en la cadena de valor.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Productor Card -->
                <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 transition-all duration-300 card-glow hover:border-green-500/50">
                    ...
                    <p class="text-zinc-400 mb-6">
                        Genera productos y los vende directamente a los vendedores. Accede a una red amplia de distribuidores.
                    </p>
                    <ul class="space-y-3">
                    ...
                    <a href="#" class="inline-flex items-center gap-2 text-green-500 font-semibold mt-8 hover:text-green-400 transition-colors">
                ...
                <!-- Vendedor Card -->
                <div class="bg-zinc-900 border border-green-500/30 rounded-2xl p-8 transition-all duration-300 card-glow hover:border-green-500/50 md:-translate-y-4 relative">
                    <div class="absolute -top-3 left-1/2 -translate-x-1/2">
                        <span class="bg-green-500 text-zinc-950 text-xs font-bold px-3 py-1 rounded-full">MAS POPULAR</span>
                    </div>
                    <div class="w-14 h-14 bg-green-500/10 rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="text-zinc-400 mb-6">
                        Compra a productores y vende a clientes finales. El puente perfecto entre la produccion y el consumo.
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center gap-3 text-sm text-zinc-300">
                            <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 transition-all duration-300 card-glow hover:border-green-500/50">
                    ...
                    <p class="text-zinc-400 mb-6">
                        Compra productos de calidad a vendedores verificados. Disfruta de la mejor experiencia de compra.
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center gap-3 text-sm text-zinc-300">
                            <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-5 gap-4 items-center">
                ...
                <div class="text-center">
                    <div class="w-20 h-20 bg-zinc-900 border-2 border-green-500 rounded-full flex items-center justify-center mx-auto mb-4">
    ...
    <section id="beneficios" class="py-24 bg-zinc-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold mt-4 mb-6">
                    Por que elegir <span class="gradient-text">EconMarket</span>
                </h2>
                <p class="text-zinc-400 max-w-2xl mx-auto">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group p-6 rounded-xl border border-zinc-800 hover:border-green-500/30 transition-colors">
                    ...
                    <p class="text-zinc-500 text-sm">Proteccion en cada operacion con encriptacion de datos y verificacion de usuarios.</p>
                </div>
                ...
                <div class="group p-6 rounded-xl border border-zinc-800 hover:border-green-500/30 transition-colors">
                    ...
                    <p class="text-zinc-500 text-sm">Procesos optimizados para que tus productos lleguen mas rapido al mercado.</p>
                </div>
                ...
                <div class="group p-6 rounded-xl border border-zinc-800 hover:border-green-500/30 transition-colors">
                    ...
                    <p class="text-zinc-500 text-sm">Dashboard completo con metricas de ventas, tendencias y comportamiento del mercado.</p>
                </div>
                ...
                <div class="group p-6 rounded-xl border border-zinc-800 hover:border-green-500/30 transition-colors">
                    ...
                    <p class="text-zinc-500 text-sm">Multiples metodos de pago y opciones de financiamiento para tu comodidad.</p>
                </div>
                ...
                <div class="group p-6 rounded-xl border border-zinc-800 hover:border-green-500/30 transition-colors">
                    ...
                    <p class="text-zinc-500 text-sm">Equipo de soporte dedicado disponible en todo momento para ayudarte.</p>
                </div>
                ...
                <div class="group p-6 rounded-xl border border-zinc-800 hover:border-green-500/30 transition-colors">
                    ...
                    <p class="text-zinc-500 text-sm">Expande tu negocio mas alla de fronteras con nuestra red internacional.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-gradient-to-b from-zinc-900 to-zinc-950">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="bg-gradient-to-br from-green-500/10 to-transparent border border-green-500/20 rounded-3xl p-8 sm:p-12">
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
                    Comienza a crecer con <span class="gradient-text">EconMarket</span>
                </h2>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a href="#" class="w-full sm:w-auto text-zinc-400 hover:text-white font-semibold px-8 py-4 transition-colors text-center">
                        Contactar Ventas
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div class="lg:col-span-1">
                    <a href="#" class="flex items-center gap-2 mb-4">
                        ...
                        <span class="text-xl font-bold">EconMarket</span>
                    </a>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Para Productores</a></li>
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Para Vendedores</a></li>
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Para Clientes</a></li>
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Precios</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Sobre Nosotros</a></li>
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Blog</a></li>
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Carreras</a></li>
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Contacto</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Terminos de Servicio</a></li>
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Politica de Privacidad</a></li>
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Cookies</a></li>
                        <li><a href="#" class="text-sm text-zinc-500 hover:text-white transition-colors">Licencias</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-zinc-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                <p class="text-sm text-zinc-500">
                    2026 EconMarket. Todos los derechos reservados.
                </p>
